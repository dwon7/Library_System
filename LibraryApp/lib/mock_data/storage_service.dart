...
class StorageService extends GetxService {
  ...
  Future<StorageService> init() async {
    ...
    books.assignAll([
      BookDetailRes(bookId: "MS-01", title: "Lập trình Flutter & GetX", categoryId: "DM-CNTT", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 10)),
      BookDetailRes(bookId: "MS-02", title: "Cấu trúc dữ liệu & Giải thuật", categoryId: "DM-CNTT", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 7)),
      BookDetailRes(bookId: "MS-03", title: "Lập trình Java cơ bản", categoryId: "DM-CNTT", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 5)),
      BookDetailRes(bookId: "MS-04", title: "Python cho khoa học dữ liệu", categoryId: "DM-CNTT", documentType: "Digital", digitalInfo: DigitalInfo(fileFormat: "PDF", fileSizeMb: "15.2", downloadCount: 230)),
      BookDetailRes(bookId: "MS-05", title: "Nhập môn AI & Machine Learning", categoryId: "DM-CNTT", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 8)),
      BookDetailRes(bookId: "MS-06", title: "Lập trình Dart từ A đến Z", categoryId: "DM-CNTT", documentType: "Digital", digitalInfo: DigitalInfo(fileFormat: "EPUB", fileSizeMb: "8.7", downloadCount: 145)),
      BookDetailRes(bookId: "MS-07", title: "Hệ điều hành Linux", categoryId: "DM-CNTT", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 6)),
      BookDetailRes(bookId: "MS-08", title: "Kinh tế học vi mô", categoryId: "DM-KT", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 12)),
      BookDetailRes(bookId: "MS-09", title: "Quản trị doanh nghiệp", categoryId: "DM-KT", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 4)),
      BookDetailRes(bookId: "MS-10", title: "Nguyên lý kế toán", categoryId: "DM-KT", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 9)),
      BookDetailRes(bookId: "MS-11", title: "Marketing căn bản", categoryId: "DM-KT", documentType: "Digital", digitalInfo: DigitalInfo(fileFormat: "PDF", fileSizeMb: "12.4", downloadCount: 312)),
      BookDetailRes(bookId: "MS-12", title: "Tài chính doanh nghiệp", categoryId: "DM-KT", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 3)),
      BookDetailRes(bookId: "MS-13", title: "Khởi nghiệp đổi mới sáng tạo", categoryId: "DM-KT", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 15)),
      BookDetailRes(bookId: "MS-14", title: "Thương mại điện tử", categoryId: "DM-KT", documentType: "Digital", digitalInfo: DigitalInfo(fileFormat: "PDF", fileSizeMb: "20.1", downloadCount: 88)),
      BookDetailRes(bookId: "MS-15", title: "Truyện Kiều", categoryId: "DM-VH", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 20)),
      BookDetailRes(bookId: "MS-16", title: "Tắt đèn", categoryId: "DM-VH", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 11)),
      BookDetailRes(bookId: "MS-17", title: "Số đỏ", categoryId: "DM-VH", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 8)),
      BookDetailRes(bookId: "MS-18", title: "Nhật ký Đặng Thùy Trâm", categoryId: "DM-VH", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 14)),
      BookDetailRes(bookId: "MS-19", title: "Tôi thấy hoa vàng trên cỏ xanh", categoryId: "DM-VH", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 6)),
      BookDetailRes(bookId: "MS-20", title: "Mắt biếc", categoryId: "DM-VH", documentType: "Digital", digitalInfo: DigitalInfo(fileFormat: "EPUB", fileSizeMb: "3.2", downloadCount: 520)),
      BookDetailRes(bookId: "MS-21", title: "English Grammar In Use", categoryId: "DM-NN", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 25)),
      BookDetailRes(bookId: "MS-22", title: "TOEIC 990", categoryId: "DM-NN", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 18)),
      BookDetailRes(bookId: "MS-23", title: "IELTS Cambridge 17", categoryId: "DM-NN", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 10)),
      BookDetailRes(bookId: "MS-24", title: "Tiếng Pháp giao tiếp", categoryId: "DM-NN", documentType: "Digital", digitalInfo: DigitalInfo(fileFormat: "MP3", fileSizeMb: "45.6", downloadCount: 67)),
      BookDetailRes(bookId: "MS-25", title: "Tiếng Nhật Minna no Nihongo", categoryId: "DM-NN", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 16)),
      BookDetailRes(bookId: "MS-26", title: "Anh văn chuyên ngành CNTT", categoryId: "DM-NN", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 5)),
      BookDetailRes(bookId: "MS-27", title: "Tiếng Hàn sơ cấp", categoryId: "DM-NN", documentType: "Digital", digitalInfo: DigitalInfo(fileFormat: "PDF", fileSizeMb: "18.3", downloadCount: 198)),
      BookDetailRes(bookId: "MS-28", title: "React Native toàn tập", categoryId: "DM-CNTT", documentType: "Physical", physicalInfo: PhysicalInfo(totalQuantity: 7)),
      BookDetailRes(bookId: "MS-29", title: "Blockchain & Cryptocurrency", categoryId: "DM-CNTT", documentType: "Digital", digitalInfo: DigitalInfo(fileFormat: "PDF", fileSizeMb: "25.0", downloadCount: 410)),
    ]);
