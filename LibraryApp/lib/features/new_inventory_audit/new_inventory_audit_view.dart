                ...
                () => Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      controller: TextEditingController(
                        text: controller.auditDate.value,
                      ),
                      onTap: () async {
                    ...
                    Row(
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () => controller.addAuditMember(),
                        ),
                      ],
                    ),
                    const SizedBox(height: 8),
                    ...controller.auditBoard.asMap().entries.map(
                      (e) => _buildMemberRow(e.key, e.value),
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        Obx(
                          () => Text("${controller.books.value.length} sách"),
                        ), // IconButton(icon: const Icon(Icons.add_circle, color: Colors.black87, size: 28), onPressed: () => controller.addAuditDetail()),
                      ],
                    ),
                    const SizedBox(height: 8),
                    ...controller.auditDetails.asMap().entries.map(
                      (e) => _buildDetailBlock(e.key, e.value),
                    ),
                  ],
                ),
              ),
  ...
  Widget _buildStatusBtn(int value, String label) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: controller.status.value == value
              ? Colors.black87
      ...
      child: Row(
        children: [
          ...
          if (controller.auditBoard.length > 1)
            IconButton(
              icon: const DeleteIcon(size: 18),
              onPressed: () => controller.removeAuditMember(index),
            ),
        ],
      ),
    );
          ...
          if (controller.auditDetails.length > 1)
            Align(
              ...
              child: IconButton(
                ...
                onPressed: () => controller.removeAuditDetail(index),
              ),
            ),
        ],
      ),
  ...
  Widget _buildCondBtn(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: entry.conditionType == value
              ? Colors.black87
              : Colors.grey.shade200,
        ...
        child: Text(
          label,
          style: TextStyle(
            color: entry.conditionType == value ? Colors.white : Colors.black87,
            fontSize: 12,
          ),
        ),
      ),
