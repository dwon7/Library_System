...
class NewInventoryLedgerView extends GetView<NewInventoryLedgerController> {
                ...
                child: Obx(
                  () => Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Expanded(child: _buildTypeOption(1, "Nhập kho")),
                          const SizedBox(width: 12),
                          Expanded(child: _buildTypeOption(2, "Xuất kho")),
                        ],
                      ),
                      ...
                      TextFormField(
                        ...
                        controller: TextEditingController(
                          text: controller.transactionDate.value,
                        ),
                        onTap: () async {
                      ...
                      ...controller.ledgerDetails.asMap().entries.map(
                        (entry) => Padding(
  ...
  void _showConfirmDialog() {
    ...
    final rows = controller.ledgerDetails
    ...
    Get.dialog(
      AlertDialog(
            ...
            children: [
              ...
              ...rows.map(
                (r) => Padding(
                  ...
                  child: Text(
                    "${r.title} - SL: ${r.qty} - Thành tiền: ${AppUtils.formatMoney(r.amount)}",
                  ),
                ),
              ),
              const Divider(),
              Text(
                "Tổng tiền: ${AppUtils.formatMoney(grandTotal)}",
        ...
        actions: [
          OutlinedButton(onPressed: () => Get.back(), child: const Text("Huỷ")),
          ElevatedButton(
            onPressed: () {
              Get.back();
              controller.submit();
    ...
    return Obx(
      () => GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: controller.ledgerType.value == type
                ? Colors.black87
            ...
            builder: (_, __) {
              ...
              return Row(
                children: [
                  ...
                  const Spacer(),
                  Text(
                    AppUtils.formatMoney(qty * price),
